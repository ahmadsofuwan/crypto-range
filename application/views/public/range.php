<div class="mx-5 my-y p-5 bg-blue-900 rounded-3xl gradient-border mt-5 opacity-95 text-slate-300">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 xl:grid-cols-3 gap-2 mt-5">
        <div class="grid grid-cols-1 gap-2 mt-5 h-fit">
            ...
            <div class="text-center font-bold text-xl capitalize text-yellow-300">Total Matic <?= $feeThree ?></div>
        ...
        <div class="grid grid-cols-1 gap-2 mt-5 h-fit">
            ...
            <div class="text-center font-bold text-xl capitalize text-yellow-300">Total Matic <?= $feeTwo ?></div>
        ...
        <div class="grid grid-cols-1 gap-2 mt-5 h-fit">
            ...
            <div class="text-center font-bold text-xl capitalize text-yellow-300">Total Matic <?= $feeOne ?></div>
