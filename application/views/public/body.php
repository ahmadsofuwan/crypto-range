    ...
    <div class="grid sm:grid-cols-1 gap-4 lg:grid-cols-3 md:grid-cols-1 gap-2 mt-5">
        <?php foreach ($reff as $key => $value) { ?>
            <div class="border-rb rounded-3xl p-0.5">
                <div class="rounded-3xl bg-indigo-900 pr-5 pb-4 p-3 flex justify-content-center">
                    <span class="flex">
                        ...
                        <span class="ml-auto mr-3 font-black"><?= $value['username'] ?></span>
                        <span class="ml-auto mr-3 font-black">Lv<?= $value['level'] ?></span>
                    </span>
                </div>
            </div>
        <?php } ?>
