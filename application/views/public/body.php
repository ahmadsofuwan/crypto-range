        ...
        <?php foreach ($reff as $key => $value) { ?>
            <div class="border-rb rounded-3xl p-0.5">
                ...
                <div class="rounded-3xl bg-indigo-900 pr-5 pb-4 p-3">
                    <?php if ($value['count'] == 9) { ?>
                        <div class="text-center font-black text-green-500">Active</div>
                    <?php } else { ?>
                        <div class="text-center font-black text-red-500">Non Active</div>
                    <?php } ?>
                    <span class="flex justify-content-start">
                        ...
                        <span class="mr-2 text-xs text-red-500">Lv<?= $value['level'] ?></span>
                        <span class="font-bold text-green-500"><?= $value['count'] ?></span>
                    </span>
                </div>
            </div>
        <?php } ?>
